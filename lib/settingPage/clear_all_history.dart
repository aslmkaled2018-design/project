...
class ClearAllHistory extends StatefulWidget {
  const ClearAllHistory({super.key});

  @override
  State<ClearAllHistory> createState() => _ClearAllHistoryState();
}

class _ClearAllHistoryState extends State<ClearAllHistory> {
  @override
